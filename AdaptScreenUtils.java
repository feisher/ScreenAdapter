package com.yusong.camarestresstesting;
...
public final class AdaptScreenUtils {
    ...
    public static int pt2Px(final float ptValue) {
        DisplayMetrics metrics = App.getInstence().getResources().getDisplayMetrics();
    ...
    private static void applyDisplayMetrics(final Resources resources, final float newXdpi) {
        ...
        App.getInstence().getResources().getDisplayMetrics().xdpi = newXdpi;
